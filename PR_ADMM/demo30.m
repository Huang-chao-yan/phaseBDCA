...
imwrite(u0,['result_J2_sig30/',namestr,'ER.png'])
imwrite(uWF_bdca,['result_J2_sig30/',namestr,'TF.png'])
imwrite(uPR_bdca,['result_J2_sig30/',namestr,'TV.png'])
imwrite(u_RAAR,['result_J2_sig30/',namestr,'RAAR.png'])
imwrite(real(u_RAF),['result_J2_sig30/',namestr,'RAF.png'])
imwrite(real(u_RWF),['result_J2_sig30/',namestr,'RWF.png'])
imwrite(real(u_TAF),['result_J2_sig30/',namestr,'TAF.png'])
imwrite(real(u_CDA),['result_J2_sig30/',namestr,'CDA.png'])