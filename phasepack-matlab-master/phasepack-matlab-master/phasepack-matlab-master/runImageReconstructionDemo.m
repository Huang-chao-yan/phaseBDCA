...
image = imread('18.tif'); % Load the image from the 'data' folder.
...
opts.algorithm = 'KaczmarzSimple';       % Use the truncated Wirtinger flow method to solve the retrieval problem.  Try changing this to 'Fienup'.
